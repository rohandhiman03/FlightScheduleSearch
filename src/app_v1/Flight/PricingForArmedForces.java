 ...
 * @author smita
 */
public class PricingForArmedForces implements IPriceDiscounting{
 /**
    * This function is for applying discount for Fare Type Armed Forces
    ...
    */
    ...
    public void UpdateFlightPrices(ArrayList<FlightInfo> a_flight) {
        ...
        {
            a_flight.get(i).m_price -= (a_flight.get(i).m_price * 30) / 100;
        }
    }
