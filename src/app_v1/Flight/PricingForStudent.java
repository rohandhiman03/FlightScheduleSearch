 ...
 * @author smita
 */
public class PricingForStudent implements IPriceDiscounting{
 /**
    * This function is for applying discount for Fare Type Student
    ...
    */
    ...
    public void UpdateFlightPrices(ArrayList<FlightInfo> a_flight) {
        ...
        {
            a_flight.get(i).m_price -= (a_flight.get(i).m_price * 10) / 100;
        } 
    }
